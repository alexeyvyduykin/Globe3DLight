...
namespace Globe3DLight.Editor
{
    public class ContainerFactory : IContainerFactory
    {
        ...
        IScenarioContainer IContainerFactory.GetScenario(string name)
        {
            ...
            var root = factory.CreateLogicalTreeNode("Root", dataFactory.CreateFrameData());
        ...
        public IProjectContainer GetDemo()
        {
          ...
          //   fileSystem.WriteUtf8Text(@"C:\resource\globe3d\data\Antenna4\fr_antenna4_true.json", str_);
            ...
            var fr_j2000 = factory.CreateLogicalTreeNode("fr_j2000", dataFactory.CreateJ2000Animator(databaseFactory.CreateJ2000Database(DateTime.Now, 0.0)));
            root.AddChild(fr_j2000);

            var fr_sun = CreateSunNode(root, @"C:\resource\globe3d\data\fr_sun.json");


            var fr_gs01 = factory.CreateLogicalTreeNode("fr_gs01", dataFactory.CreateGroundStationData(
                databaseFactory.CreateGroundStationDatabase(36.26, 54.97, 0.223)));
            var fr_gs02 = factory.CreateLogicalTreeNode("fr_gs02", dataFactory.CreateGroundStationData(
                databaseFactory.CreateGroundStationDatabase(30.201389, 59.712777, 0.128)));
            var fr_gs03 = factory.CreateLogicalTreeNode("fr_gs03", dataFactory.CreateGroundStationData(
                databaseFactory.CreateGroundStationDatabase(37.0532, 55.5856, 0.204)));
            var fr_gs04 = factory.CreateLogicalTreeNode("fr_gs04", dataFactory.CreateGroundStationData(
                databaseFactory.CreateGroundStationDatabase(107.945, 51.87111, 0.621)));
            var fr_gs05 = factory.CreateLogicalTreeNode("fr_gs05", dataFactory.CreateGroundStationData(
                databaseFactory.CreateGroundStationDatabase(37.9678, 55.9494, 0.157)));
            var fr_gs06 = factory.CreateLogicalTreeNode("fr_gs06", dataFactory.CreateGroundStationData(
                databaseFactory.CreateGroundStationDatabase(131.7575, 44.0247, 0.080)));
            var fr_gs07 = factory.CreateLogicalTreeNode("fr_gs07", dataFactory.CreateGroundStationData(
                databaseFactory.CreateGroundStationDatabase(136.7536, 50.6856, 0.222)));
            var fr_gs08 = factory.CreateLogicalTreeNode("fr_gs08", dataFactory.CreateGroundStationData(
                databaseFactory.CreateGroundStationDatabase(38.39, 55.1536111, 0.189)));
            var fr_gs09 = factory.CreateLogicalTreeNode("fr_gs09", dataFactory.CreateGroundStationData(
                databaseFactory.CreateGroundStationDatabase(107.934166, 51.864722, 0.633)));
