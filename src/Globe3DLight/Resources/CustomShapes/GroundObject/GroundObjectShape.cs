...
{
    //public class GroundObjectShape : ISceneShape
    //{
    ...
    //    public IEnumerable<vec3> Positions { get; set; }

    //    public GroundObjectShape(IDevice device)
    //    {
    //        this._device = device;
    //    }
    ...
    //        context.DrawPoints(Positions, Colors.Red, 2.0f);
    //    }
    //}
}
